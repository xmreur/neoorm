...
function spatialWriteExpression(col: ManifestColumn, paramIndex: number): string {
...
function createSpatialTypePlugin(
  ...
  return {
    ...
    createBuilder(options?: Record<string, unknown>) {
      ...
      return createColumnBuilder<GeoJsonGeometry | null, ColumnMeta & { kind: typeof kind; typeOptions: Record<string, unknown> }>({
        kind,
        nullable: true,
        unique: false,
        primary: false,
    ...
    columnType(col) {
      return spatialSqlType(base, col.typeOptions as GeometryOptions | undefined);
    },
    columnTsType(col) {
...
export function geometry(options?: GeometryOptions) {
  return geometryType.createBuilder(options as Record<string, unknown> | undefined);
}

export function geography(options?: GeographyOptions) {
  return geographyType.createBuilder(options as Record<string, unknown> | undefined);
}

export function point(options?: PointOptions) {
  return pointType.createBuilder(options as Record<string, unknown> | undefined);
}

...
/** Generated model type name: PascalCase singular of the table accessor. */
export function modelTypeName(accessor: string): string {
	return pascalCase(singularize(accessor));
}

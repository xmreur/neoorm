...
type InferTupleElements<
	TElements extends readonly ValidationType[],
> = {
...
export type InferValidationType<T extends ValidationType> =
					...
					: T extends { kind: "date" }
						...
						: T extends {
							...
							: T extends { kind: "unknown" }
								? unknown
								: T extends { kind: "array"; element: infer E extends ValidationType }
									? InferValidationType<E>[]
									: T extends {
											kind: "object";
											fields: infer F extends readonly ValidationField[];
										}
										? InferObjectFields<F>
										: T extends {
												kind: "record";
												value: infer V extends ValidationType;
											}
											? Record<string, InferValidationType<V>>
											: T extends {
													kind: "union";
													variants: infer V extends readonly ValidationType[];
												}
												...
												: T extends {
													...
													: T extends {
															kind: "tuple";
															elements: infer E extends readonly ValidationType[];
														}
